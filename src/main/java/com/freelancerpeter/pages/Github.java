...
content = new VerticalLayout();
		...
		Span desc2 =  new Span("WebsiteChecker is able to add, check and display information about added websites availability based on http responses. After checking it "
		...
		textcontent3.add("SoundSea is desktop FXML application that allows you to search, play and download mp3 songs for free :-)\n");
		...
		Span desc4 =  new Span("It has multiple uses from farming nearby villages to storage work and player attack farming. Barbarian village farming is based on Knapsack algorithm and "
		...
		Span desc5 =  new Span("MyBlood Bank is an attempt for a blood donation web site using Vaadin. It has some basic functions like Install Setup, language change, "
		...
		Span desc6 =  new Span("QueryByExample-FX has multiple database support MySQL/OracleDB/MongoDB and multi-column table selection(if I remember right). It also "
